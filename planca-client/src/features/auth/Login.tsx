      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <div className="flex justify-center">
            <div className="h-20 w-20 rounded-full bg-white shadow-lg flex items-center justify-center mb-4 border-2 border-primary-100 transform transition-all duration-300 hover:scale-105 dark:bg-gray-800 dark:border-primary-800">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2 dark:text-white">Planca</h1>
          <h2 className="text-xl font-semibold text-gray-800 mb-2 dark:text-gray-200">Hesabınıza Giriş Yapın</h2>
              ...
              <Form className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm">
                    <a href="#" className="font-medium text-primary-600 hover:text-primary-500 transition-colors dark:text-primary-400 dark:hover:text-primary-300">
                ...
                <div className="relative my-6">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-white text-gray-500 dark:bg-gray-800 dark:text-gray-400">veya şununla devam edin</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button 
                    type="button" 
                    className="flex items-center justify-center px-4 py-2 border border-gray-200 rounded-lg shadow-sm hover:border-primary-300 hover:text-primary-600 transition-all duration-300 ease-in-out transform hover:-translate-y-0.5 dark:border-gray-600 dark:hover:border-primary-500 dark:text-gray-200 dark:hover:text-primary-400 dark:bg-gray-700 dark:hover:bg-gray-600"
                  >
        ...
        <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400 flex justify-center space-x-4">
          <a href="#" className="font-medium text-gray-600 hover:text-gray-500 transition-colors dark:text-gray-300 dark:hover:text-gray-200">
            Gizlilik Politikası
          </a>
