...
const Button = ({
  ...
  const baseClasses = 'focus:cursor-pointer inline-flex items-center justify-center font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all duration-200 ease-in-out shadow-sm';
  
  // Use direct hex colors for more reliability
  const variantClasses = {
    primary: 'bg-[#cc3333] text-white hover:bg-[#b22222] focus:ring-[#e05252]',
    secondary: 'bg-emerald-600 text-white hover:bg-emerald-700 focus:ring-emerald-500',
    outline: 'border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 focus:ring-[#e05252]',
