...
namespace Planca.Infrastructure.Migrations
{
    ...
    [Migration("20250630162748_AddGuestAppointmentFields")]
    partial class AddGuestAppointmentFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Planca.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.Property<bool>("IsGuestAppointment")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("isguestappointment");
                    ...
                    b.HasIndex("EmployeeId")
                        .HasDatabaseName("ix_appointments_employeeid");

                    b.HasIndex("GuestEmail");

                    b.HasIndex("IsGuestAppointment");

                    b.HasIndex("ServiceId")
                        .HasDatabaseName("ix_appointments_serviceid");
                    ...
                    b.HasIndex("TenantId", "IsGuestAppointment", "Status");
            ...
            modelBuilder.Entity("Planca.Domain.Entities.Setting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Planca.Domain.Entities.Appointment", b =>
                {
                    b.HasOne("Planca.Domain.Entities.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired()
                        .HasConstraintName("fk_appointments_customers_customerid");

                    b.HasOne("Planca.Domain.Entities.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_appointments_employees_employeeid");

                    b.HasOne("Planca.Domain.Entities.Service", "Service")
                        .WithMany()
                        .HasForeignKey("ServiceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_appointments_services_serviceid");
